...
la couverture du code par ces tests, qui est supérieure à 90\%.
...
% TODO détailler le fonctionnement

% TODO complexité

% TODO mettre la justification dans une partie "[pour] aller plus loin" ?
...
% + inclure le résultat de chaque algo sur l'exemple du sujet
